...
class News extends Component {
  ...
  componentDidUpindirim(prevProps) {
  ...
  render() {
    ...
    return (
      <div className="row mx-0">
        <div className="col-md-8 animate-box" data-animate-effect="fadeIn">
          <div className="container-fluid pb-4 pt-4 paddding">
            {blogs.map((blog, index) => (
              <div
                key={index}
                className="row pb-4"
                onClick={() => this.props.onBlogClick(blog)}
              >
                ...
                <div className="col-md-7 animate-box">
                  ...
                  <div className="fh5co_consectetur">
                    <i className=""></i> {blog.fiyat}
                  </div>
                  <br></br>
                   <Button style={{ backgroundColor: "mediumorchid", color: "blue" }} onClick={() => this.props.addTo(bloglar)} > 
                    Sepete Ekle
                  </Button> 
                  <br></br>
                  <div className="fh5co_consectetur">
